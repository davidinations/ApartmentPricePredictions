...
# Check the file size
file_size = os.path.getsize("D:\\david\\OneDrive\\Documents\\Future\\Project\\Application\\Education\\Purwadhika\\Capstone\\ApartmentData\\Notebook\\gbr_finalmodel.pkl")
if file_size == 0:
    print("The file is empty")
else:
    # Try to load the file
    try:
        with open("D:\\david\\OneDrive\\Documents\\Future\\Project\\Application\\Education\\Purwadhika\\Capstone\\ApartmentData\\Notebook\\gbr_finalmodel.pkl", "rb") as file:
...
def predict(input_data: InputData):
    # Proses input_data menggunakan model
